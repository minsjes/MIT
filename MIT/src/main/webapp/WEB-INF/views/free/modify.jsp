...
<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid px-4">
			<h2 class="mt-4" style='text-align: center; margin-bottom: 30px;'>자유 게시판 게시물 수정하기</h2>
			...
			<form role="form" action="modify" method="post" name="frm">
				...
				<div class="row">
					<div class="col" style="padding-right: 0;">
						<div class="input-group">
							...
							<input type="text" class="form-control" name="memberName" value="${freeVO.memberName}" readonly="readonly">
						</div>
					</div>
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" name='freeTitle' value="${freeVO.freeTitle}">
				</div>
				<div class="form-group">
					<div class="input-group-text" style="padding-left: 20px;">내용</div>
					<textarea class="form-control" name="freeContent" rows="15">${freeVO.freeContent}</textarea>
				</div>
												...
												<c:if test="${status.last}">
													<c:choose>
														...
														<c:when test="${token eq 'jpg' || token eq 'gif' || token eq 'png' || token eq 'bmp' }">
															<img data-dz-thumbnail="" class="avatar-sm rounded bg-light preview-size" src="/displayFile?fileName=${fVo.fileLocation}">
														</c:when>
				...
				<div style="text-align: right; margin: 17px 0 17px 0;">
					...
					<button type="button" class="btn btn-outline-dark" onclick="location.href='/free/list'">목록</button>
				</div>
			</form>
		</div>
	</main>
