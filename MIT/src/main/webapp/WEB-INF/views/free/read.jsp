	...
	<div class="container-fluid px-4">
		...
		<form role="form" action="modify" method="post">
			<input type='hidden' id="freeNo" name="freeNo"
				value="${freeVO.freeNo}"> <input type='hidden' id="memberNo"
				value="${freeVO.memberNo}">
			...
			<div class="row g-0">
					...
					<div class="input-group">
						...
						<c:if test="${0 eq freeVO.hiddenStatus}">
							<input type="text" class="form-control"
								value="${freeVO.memberName}" readonly="readonly">
						</c:if>
				...
				<div class="col">
					<div class="input-group">
						...
						<input type="text" class="form-control" value="${freeVO.freeView}"
							readonly="readonly">
					</div>
				</div>
			</div>
			...
			<div style="text-align: right; margin: 17px 0 17px 0;">
				...
				<c:if
					test="${12345678 eq login.memberNo && 12345678 ne freeVO.memberNo}">
					<button type="button" class="btn btn-outline-danger">삭제</button>
				</c:if>
