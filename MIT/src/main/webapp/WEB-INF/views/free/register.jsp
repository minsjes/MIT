...
<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid px-4">
			<h2 class="mt-4" style="text-align: center; margin-bottom: 30px;">자유 게시판 게시물 등록하기</h2>
			...
			<form role="form" method="post" name="frm">
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="freeContent" name="freeContent" rows="15" placeholder="Enter content..."></textarea>
				</div>
...
<script>
	...
	function validate() {
		...
		var freeContent = $("#freeContent").val();
		...
		if (freeContent == "") {
			alert("내용을 입력해주세요 .");
			document.getElementById("freeContent").focus();
			return false;
		}
