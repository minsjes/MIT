...
<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid px-4">
			<h1 class="mt-4" style='text-align: center; margin-bottom: 30px;'>정보 공유 게시판</h1>
	
			<div class="card mb-4">
				<div class="card-header">
					<span style="vertical-align: middle;">
						<i class="bi bi-chat-square-text"></i> 정보 공유 게시판 목록
					</span>
						...
						<tbody>
							<c:forEach items="${list}" var="infoVO" varStatus="status">
								<tr>
									...
									<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${infoVO.infoDate}"/></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
