...
<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid px-4">
			<h1 class="mt-4" style="text-align: center; margin-bottom: 30px;">진로 정보 공유 게시판 게시물 등록하기</h1>
			...
			<form role="form" action="register" method="post" name="form">
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="infoContent" name="infoContent"></textarea>
					<script>
