...
<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid px-4">
			<h2 class="mt-4" style="text-align: center; margin-bottom: 30px;">정보 공유 게시판 게시물 등록하기</h2>
			...
			<form role="form" method="post" name="frm">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" id="infoTitle" name="infoTitle" placeholder="Enter Title...">
				</div>
				<div class="form-group">
					<div class="input-group-text">내용</div>
					<textarea class="form-control" id="infoContent" name="infoContent" rows="15" placeholder="Enter content..."></textarea>
				</div>
