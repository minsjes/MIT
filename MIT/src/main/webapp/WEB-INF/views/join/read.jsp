	...
	<main>
		...
		<div class="container-fluid px-4">
			<div class="box-header">
				<h2 class="mt-4" style='text-align: center; margin-bottom: 30px;'>가입 관리</h2>
			</div>
				...
				<div class="card-body" style="padding-right:350px; padding-left: 350px;">
					<div class="form-group">
						...
						<div class="input-group mb-3">
							...
							<input type="text" name='joinName' class="form-control" value="${joinVO.joinName}" readonly="readonly">
						</div>
					...
					<div class="form-group">
						...
						<div class="input-group mb-3">
							...
							<input type="text" name='joinNo' class="form-control" value="${joinVO.joinNo}" readonly="readonly">
						</div>
					...
					<div class="form-group">
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="joinPhone" class="form-control" value="${joinVO.joinPhone}" readonly="readonly">
						</div>
					...
					<div class="form-group">
						...
						<div class="input-group mb-3">
							<span class="input-group-text" id="basic-addon1"><i class="far fa-thumbs-up"></i></span>
							<textarea class="form-control" name="joinText" rows="3" readonly="readonly">${joinVO.joinText}</textarea>
						</div>
					...
					<div class="form-group">
						...
						<div class="input-group mb-3">
							<span class="input-group-text" id="basic-addon1"><i class="far fa-bell"></i></span>
							<c:if test="${joinVO.allowStatus == '0'}">
								<input type="text" name="allowStatus" class="form-control" value="대기" readonly="readonly">
							</c:if>
							<c:if test="${joinVO.allowStatus == '1'}">
								<input type="text" name="allowStatus" class="form-control" value="승인" readonly="readonly">
							</c:if>
							<c:if test="${joinVO.allowStatus == '2'}">
								<input type="text" name="allowStatus" class="form-control" value="거절" readonly="readonly">
							</c:if>
						</div>
					</div>
				</div>
