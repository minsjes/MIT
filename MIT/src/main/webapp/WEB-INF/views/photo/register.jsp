...
<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid px-4">
			<h2 class="mt-4" style="text-align: center; margin-bottom: 30px;">포토 갤러리  등록하기</h2>
			...
			<form role="form" method="post" name="frm">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" id="photoTitle" name="photoTitle" placeholder="Enter Title...">
				</div>
				<div class="form-group">
					<div class="input-group-text">내용</div>
					<textarea class="form-control" id="photoContent" name="photoContent" rows="15" placeholder="Enter content..."></textarea>
				</div>
...
<script>
	...
	function validate() {
		...
		if (photoContent == "") {
			alert("내용을 입력해주세요 .");
			document.getElementById("photoContent").focus();
			return false;
		}
