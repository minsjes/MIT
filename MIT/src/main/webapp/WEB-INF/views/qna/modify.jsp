...
<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid px-4">
			<h1 class="mt-4" style='text-align: center; margin-bottom: 30px;'>질문 게시판 게시물 수정하기</h1>
			...
			<form role="form" action="modify" method="post" name="frm">
				...
				<div class="row g-0">
					<div class="col-lg-2">
						<div class="input-group">
							<label class="input-group-text" for="inputGroupSelect01" style="padding: 0 20px 0 20px;">유형</label>
					...
					<div class="col-lg-10">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="qnaTitle" name="qnaTitle" value="${qnaVO.qnaTitle}">
						</div>
					</div>
				</div>
