...
<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid px-4">
			<h2 class="mt-4" style='text-align: center; margin-bottom: 30px;'>문의 게시판 게시물 수정하기</h2>
			...
			<form role="form" action="modify" method="post" name="frm">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" name='qnaTitle' value="${qnaVO.qnaTitle}">
				</div>
				...
				<div class="row">
					<div class="col" style="padding-right: 0;">
						<div class="input-group">
							...
							<input type="text" class="form-control" name="memberName" value="${qnaVO.memberName}" readonly="readonly">
						</div>
					</div>
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="qnaContent" rows="15">${qnaVO.qnaContent}</textarea>
				</div>
				...
				<div class="card">
					<ul class="dropzone-previews clearfix uploadedList preview-list">
						<c:forEach items="${qnaFileVO}" var="qVo" varStatus="status">
							<c:set var="fileName" value="${qVo.fileName}" />
								...
								<div class="card mt-1 mb-0 shadow-none border dz-processing dz-image-preview dz-success dz-complete">
									<div class="p-2">
										<div class="row align-items-center px-3">
												...
												<c:if test="${status.last}">
													<c:choose>
														...
														<c:when test="${token eq 'jpg' || token eq 'gif' || token eq 'png' || token eq 'bmp' }">
															<img data-dz-thumbnail="" class="avatar-sm rounded bg-light preview-size" src="/displayFile?fileName=${qVo.fileLocation}">
														</c:when>
											...
											<div class="col pl-0">
												<a href="/displayFile?fileName=${qVo.fileLocation}" text-muted font-weight-bold data-dz-name="">
													${qVo.fileName}
												</a>
											</div>
											<div class="col-auto">
												<a href="${qVo.fileLocation}" class="btn btn-default btn-xs pull-right delbtn">
				...
				<div style="text-align: right; margin: 17px 0 17px 0;">
					...
					<button type="button" class="btn btn-outline-dark" onclick="location.href='/qna/list'">목록</button>
				</div>
			</form>
		</div>
	</main>
