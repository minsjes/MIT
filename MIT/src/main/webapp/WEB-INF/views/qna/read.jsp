				...
				<div class="row g-0">
					...
					<div class="col">
						<div class="input-group">
							...
							<input type="text" class="form-control" value="${qnaVO.qnaDate}" readonly="readonly">
						</div>
					</div>
					<div class="col">
						<div class="input-group">
					...
					<div class="col-lg-2">
						<div class="input-group">
							...
							<c:if test="${1 eq qnaVO.qnaClass}">
								<input type="text" class="form-control" value="동아리" readonly="readonly">
							</c:if>
							<c:if test="${2 eq qnaVO.qnaClass}">
								<input type="text" class="form-control" value="코딩오류" readonly="readonly">
							</c:if>
							<c:if test="${3 eq qnaVO.qnaClass}">
								<input type="text" class="form-control" value="전공과목" readonly="readonly">
							</c:if>
							<c:if test="${4 eq qnaVO.qnaClass}">
								<input type="text" class="form-control" value="학교생활" readonly="readonly">
							</c:if>
						</div>
					</div>
