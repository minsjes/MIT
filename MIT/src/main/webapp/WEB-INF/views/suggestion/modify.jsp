...
<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid px-4">
			<h1 class="mt-4" style='text-align: center; margin-bottom: 30px;'>건의사항 수정하기</h1>
			...
			<form role="form" action="modify" method="post" name="frm">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" name="memberName" value="${suggestionVO.memberName}" readonly>
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" name='suggestionTitle' value="${suggestionVO.suggestionTitle}">
				</div>
				
				<div class="form-group">
					<div class="input-group-text">&nbsp;내용</div>
					<textarea class="form-control" id="suggestionContent" name="suggestionContent">${suggestionVO.suggestionContent}</textarea>
					<script>
				...
				<div class="card">
					<ul class="dropzone-previews clearfix uploadedList preview-list">
						<c:forEach items="${suggestionFileVO}" var="fVo" varStatus="status">
				...
				<div style="text-align: right; margin: 17px 0 17px 0;">
					...
					<button type="button" class="btn btn-outline-dark" onclick="location.href='/suggestion/list'">목록</button>
				</div>
			</form>
		</div>
	</main>
...
<script>
	...
	function validate() {
		...
		var suggestionContent = CKEDITOR.instances.suggestionContent.getData();
