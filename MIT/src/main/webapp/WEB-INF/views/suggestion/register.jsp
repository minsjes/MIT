...
<div id="layoutSidenav_content">
	<main>
		<div class="container-fluid px-4">
			<h1 class="mt-4" style="text-align: center; margin-bottom: 30px;">건의사항 등록하기</h1>
			...
			<form role="form" action="register" method="post" name="frm">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" id="suggestionTitle" name="suggestionTitle" placeholder="Enter Title...">
				</div>
				
				<div class="form-group">
					<div class="input-group-text">&nbsp;내용</div>
					<textarea class="form-control" id="suggestionContent" name="suggestionContent"></textarea>
					<script>
